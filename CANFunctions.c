...
//    CAN_setupMessageObject(CANA_BASE, 2, 0x21, CAN_MSG_FRAME_STD, CAN_MSG_OBJ_TYPE_TX, 0, CAN_MSG_OBJ_TX_INT_ENABLE, 8);
//    CAN_setupMessageObject(CANA_BASE, 3, 0x21, CAN_MSG_FRAME_STD, CAN_MSG_OBJ_TYPE_TX, 0, CAN_MSG_OBJ_TX_INT_ENABLE, 8);

//    FOR SAMPLE TESTING
//    CAN_setupMessageObject(CANA_BASE, 4, 0x21, CAN_MSG_FRAME_STD, CAN_MSG_OBJ_TYPE_RX, 0, CAN_MSG_OBJ_RX_INT_ENABLE, 8);
    CAN_setupMessageObject(CANA_BASE, 5, 0x31, CAN_MSG_FRAME_STD, CAN_MSG_OBJ_TYPE_RX, 0, CAN_MSG_OBJ_RX_INT_ENABLE, 8);
//    CAN_setupMessageObject(CANA_BASE, 6, 0x41, CAN_MSG_FRAME_STD, CAN_MSG_OBJ_TYPE_RX, 0, CAN_MSG_OBJ_RX_INT_ENABLE, 8);

//    FOR THE ACTUAL MCU RECEPTION
//    CAN_setupMessageObject(CANA_BASE, 7, 0x31, CAN_MSG_FRAME_STD, CAN_MSG_OBJ_TYPE_RX, 0, CAN_MSG_OBJ_RX_INT_ENABLE, 8);
